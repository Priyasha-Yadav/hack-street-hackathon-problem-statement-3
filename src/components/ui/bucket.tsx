...
const INITIAL_CHIPS = [
  {
    ...
    description: "₹10,000",
    icon: BrainIcon, // more direct than sparkles
  },
  {
    id: 2,
    title: "Web3 & DeFi",
    description: "₹10,000",
    icon: BlockchainIcon, // very specific to domain
  },
  {
    id: 3,
    title: "Climate Tech",
    description: "₹10,000",
    icon: LeafIcon, // universally recognized
  },
  {
    id: 4,
    title: "Health Tech",
    description: "₹10,000",
    icon: HeartPulse, // more "medical" than generic heart
  },
  {
    id: 5,
    title: "People's Choice",
    description: "₹5,000",
    icon: ThumbsUpIcon, // intuitive voting symbol
  },
  {
    id: 6,
    title: "Best Design",
    description: "₹5,000",
    icon: PaintBrushIcon, // creative/design signal
  },
];
